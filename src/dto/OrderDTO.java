...
public record OrderDTO(String name, String orderId, LocalDate date, String orderAmount, OrderStatus orderStatus,
		...
		double netAmount, double taxAmount, double totalAmount, String currency, Company toCompany) {

	public OrderDTO(Order o) {
	    this(o.getFromCompany().getName(), o.getOrderID(), o.getOrderDateTime(), Double.toString(o.getTotalAmount()), o.getOrderStatus(),
	         ...
	         o.getTotalAmount(), o.getCurrency(), o.getToCompany());
	}
