...
public class Seed {
	...
	private void addCompanies() {
		...
		companyList.add(new Company("SP234567890", "logo24.png",
				...
				List.of("PayPal", "Stripe"), new Date(), List.of(49151, 47126, 47128, 47090)));
		companyList.add(new Company("SK245678901", "logo25.png",
				...
				6543210987L, List.of("Credit Card", "Bank Transfer"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(
				new Company("DK267890123", "logo27.png", new Address("Denmark", "Copenhagen", "1123", "Nyhavn", "123"),
						...
						8765432109L, List.of("PayPal", "Bank Transfer"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(new Company("CH356789012", "logo36.png",
				...
				2678901234L, List.of("PayPal", "Bitcoin"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(
				new Company("SP401234567", "logo41.png", new Address("Spain", "Barcelona", "08002", "La Rambla", "789"),
						...
						4012345678L, List.of("PayPal", "Bank Transfer"), new Date(), List.of(49151, 47126, 47128, 47090)));
		// 40
		...
		companyList.add(
				new Company("DE423456789", "logo43.png", new Address("Germany", "Frankfurt", "60313", "Zeil", "456"),
						...
						4234567890L, List.of("PayPal", "Bank Transfer"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(new Company("UK445678901", "logo45.png",
				...
				4456789012L, List.of("PayPal", "Stripe"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(new Company("JP467890123", "logo47.png",
				...
				List.of("PayPal", "Bitcoin"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(new Company("US523456789", "logo53.png",
				...
				5234567890L, List.of("PayPal", "Bitcoin"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(
				new Company("IT556789012", "logo56.png", new Address("Italy", "Naples", "80132", "Via Toledo", "789"),
						...
						5567890123L, List.of("PayPal", "Bitcoin"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(
				new Company("CA90123456L", "logo60.png", new Address("Canada", "Toronto", "M5B 1R7", "Yonge St", "123"),
						...
						5901234567L, List.of("PayPal", "Stripe"), new Date(), List.of(49151, 47126, 47128, 47090)));
		companyList.add(new Company("DE601234567", "logo61.png",
				...
				6012345678L, List.of("Credit Card", "Bank Transfer"), new Date(), List.of(49151, 47126, 47128, 47090)));
		// 60
		...
		companyList.add(new Company("BE801234567", "logo81.png",
				...
				8012345678L, List.of("Credit Card", "Bank Transfer"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(
				new Company("BE834567890", "logo84.png", new Address("Belgium", "Bruges", "8000", "Burg Square", "123"),
						...
						8345678901L, List.of("PayPal", "Bank Transfer"), new Date(), List.of(49151, 47126, 47128, 47090)));
		companyList.add(
				new Company("BE845678901", "logo85.png", new Address("Belgium", "Leuven", "3000", "Oude Markt", "456"),
						...
						8456789012L, List.of("Credit Card", "Bitcoin"), new Date(), List.of(49151, 47126, 47128, 47090)));
		...
		companyList.add(new Company("BE878901234", "logo88.png",
				...
				8789012345L, List.of("PayPal", "Bitcoin"), new Date(), List.of(49151, 47126, 47128, 47090)));
