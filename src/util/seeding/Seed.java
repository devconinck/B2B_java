...
public class Seed {
	...
	private void addCompanies() {
		...
		companyList.add(new Company("US123456789", "company_logo_1.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.PAYPAL), new Date(), null));
		companyList.add(new Company("CT987654321", "company_logo_2.png",
				...
				List.of(PaymentOption.BANK_TRANSFER, PaymentOption.BITCOIN), new Date(), null));
		companyList.add(
				new Company("CA345678901", "logo3.png", new Address("Canada", "Toronto", "M5V 2L7", "King St W", "789"),
						...
						1357924680L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.STRIPE), new Date(), null));
		companyList.add(new Company("UK234567890", "logo4.png",
				...
				List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), new Date(), null));
		companyList.add(new Company("DE456789012", "logo5.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), new Date(), null));
		companyList.add(new Company("FR567890129", "logo6.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), new Date(), null));
		companyList.add(
				new Company("AS678901234", "logo7.png", new Address("Australia", "Sydney", "2000", "George St", "456"),
						...
						7539518462L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), new Date(), null));
		companyList.add(
				new Company("JP789012345", "logo8.png", new Address("Japan", "Tokyo", "100-0004", "Shibakoen", "789"),
						...
						1592637480L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), new Date(), null));
		...
		companyList.add(new Company("SA901234567", "logo10.png",
				...
				9876543210L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), new Date(), null));
		// 10
		companyList.add(
				new Company("ES109876543", "logo11.png", new Address("Spain", "Madrid", "28001", "Gran Vía", "789"),
						...
						1234567890L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.STRIPE), new Date(), null));
		companyList.add(
		...
		companyList.add(new Company("IN321098765", "logo13.png",
				...
				3456789012L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), new Date(), null));
		companyList.add(
				new Company("CH43210987", "logo14.png", new Address("China", "Shanghai", "200002", "Nanjing Rd", "789"),
						...
						4567890123L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), new Date(), null));
		...
		companyList.add(new Company("MX654321098", "logo16.png",
				...
				6789012345L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), new Date(), null));
		companyList.add(new Company("CA765432109", "logo17.png",
				...
				7890123456L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), new Date(), null));
		companyList.add(new Company("DE876543210", "logo18.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.STRIPE), new Date(), null));
		...
		companyList.add(new Company("SP234567890", "logo24.png",
				...
				List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), new Date(), null));
		companyList.add(new Company("SK245678901", "logo25.png",
				...
				6543210987L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), new Date(), null));
		...
		companyList.add(
				new Company("DK267890123", "logo27.png", new Address("Denmark", "Copenhagen", "1123", "Nyhavn", "123"),
						...
						8765432109L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), new Date(), null));
		...
		companyList.add(new Company("CH356789012", "logo36.png",
				...
				2678901234L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), new Date(), null));
		...
		companyList.add(
				new Company("SP401234567", "logo41.png", new Address("Spain", "Barcelona", "08002", "La Rambla", "789"),
						...
						4012345678L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), new Date(), null));
		// 40
		...
		companyList.add(
				new Company("DE423456789", "logo43.png", new Address("Germany", "Frankfurt", "60313", "Zeil", "456"),
						...
						4234567890L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), new Date(), null));
		...
		companyList.add(new Company("UK445678901", "logo45.png",
				...
				4456789012L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), new Date(), null));
		...
		companyList.add(new Company("JP467890123", "logo47.png",
				...
				List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), new Date(), null));
		...
		companyList.add(new Company("US523456789", "logo53.png",
				...
				5234567890L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), new Date(), null));
		...
		companyList.add(
				new Company("IT556789012", "logo56.png", new Address("Italy", "Naples", "80132", "Via Toledo", "789"),
						...
						5567890123L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), new Date(), null));
		...
		companyList.add(
				new Company("CA90123456L", "logo60.png", new Address("Canada", "Toronto", "M5B 1R7", "Yonge St", "123"),
						...
						5901234567L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), new Date(), null));
		companyList.add(new Company("DE601234567", "logo61.png",
				...
				6012345678L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), new Date(), null));
		// 60
		...
		companyList.add(new Company("BE801234567", "logo81.png",
				...
				8012345678L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), new Date(), null));
		...
		companyList.add(
				new Company("BE834567890", "logo84.png", new Address("Belgium", "Bruges", "8000", "Burg Square", "123"),
						...
						8345678901L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), new Date(), null));
		companyList.add(
				new Company("BE845678901", "logo85.png", new Address("Belgium", "Leuven", "3000", "Oude Markt", "456"),
						...
						8456789012L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), new Date(), null));
		...
		companyList.add(new Company("BE878901234", "logo88.png",
				...
				8789012345L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), new Date(), null));
