	...
	private void addCompanies() {
		...
		companyList.add(
				new Company("CA345678901", "logo3.png", new Address("Canada", "Toronto", "M5V 2L7", "King St W", "789"),
						...
						1357924680L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.STRIPE), LocalDate.now(), null, null));
		...
		companyList.add(
				new Company("JP789012345", "logo8.png", new Address("Japan", "Tokyo", "100-0004", "Shibakoen", "789"),
						...
						1592637480L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		...
		companyList.add(
				new Company("ES109876543", "logo11.png", new Address("Spain", "Madrid", "28001", "Gran Vía", "789"),
						...
						1234567890L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.STRIPE), LocalDate.now(), null, null));
		companyList.add(
		...
		companyList.add(new Company("SK245678901", "logo25.png",
				...
				6543210987L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		...
		companyList.add(
				new Company("SP401234567", "logo41.png", new Address("Spain", "Barcelona", "08002", "La Rambla", "789"),
						...
						4012345678L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		// 40
		...
		companyList.add(
				new Company("DE423456789", "logo43.png", new Address("Germany", "Frankfurt", "60313", "Zeil", "456"),
						...
						4234567890L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		...
		companyList.add(
				new Company("IT556789012", "logo56.png", new Address("Italy", "Naples", "80132", "Via Toledo", "789"),
						...
						5567890123L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null));
		...
		companyList.add(new Company("DE601234567", "logo61.png",
				...
				6012345678L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		// 60
		...
		companyList.add(new Company("BE801234567", "logo81.png",
				...
				8012345678L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		...
		companyList.add(
				new Company("BE834567890", "logo84.png", new Address("Belgium", "Bruges", "8000", "Burg Square", "123"),
						...
						8345678901L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		companyList.add(
				new Company("BE845678901", "logo85.png", new Address("Belgium", "Leuven", "3000", "Oude Markt", "456"),
						...
						8456789012L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), LocalDate.now(), null, null));
