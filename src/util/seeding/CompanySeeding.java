...
public class CompanySeeding {
	...
	private void seeding() {
		...
		companyList.add(new Company("CT987654321", "company_logo_2.png",
				...
				List.of(PaymentOption.BANK_TRANSFER, PaymentOption.BITCOIN), LocalDate.now(), null, null));
		...
		companyList.add(new Company("SA901234567", "logo10.png",
				...
				9876543210L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		// 10
		...
		companyList.add(new Company("IN321098765", "logo13.png",
				...
				3456789012L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), LocalDate.now(), null, null));
		companyList.add(
				new Company("CH43210987", "logo14.png", new Address("China", "Shanghai", "200002", "Nanjing Rd", "789"),
						...
						4567890123L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), LocalDate.now(), null, null));
		...
		companyList.add(new Company("MX654321098", "logo16.png",
				...
				6789012345L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), LocalDate.now(), null, null));
		companyList.add(new Company("CA765432109", "logo17.png",
				...
				7890123456L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		...
		companyList.add(new Company("SP234567890", "logo24.png",
				...
				List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), LocalDate.now(), null, null));
		...
		companyList.add(new Company("DK267890123", "logo27.png",
				...
				8765432109L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null));
		...
		companyList.add(new Company("CH356789012", "logo36.png",
				...
				2678901234L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null));
		...
		companyList.add(new Company("UK445678901", "logo45.png",
				...
				4456789012L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), LocalDate.now(), null, null));
		...
		companyList.add(new Company("JP467890123", "logo47.png",
				...
				List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null));
		...
		companyList.add(new Company("US523456789", "logo53.png",
				...
				5234567890L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null));
		...
		companyList.add(
				new Company("CA90123456L", "logo60.png", new Address("Canada", "Toronto", "M5B 1R7", "Yonge St", "123"),
						...
						5901234567L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), LocalDate.now(), null, null));
		...
		companyList.add(new Company("BE878901234", "logo88.png",
				...
				8789012345L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null));
