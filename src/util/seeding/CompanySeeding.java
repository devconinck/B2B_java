...
public class CompanySeeding {
	
	private GenericDao<Company> companyRepo;
	private List<Company> companyList = new ArrayList<>();

	public CompanySeeding(GenericDao<Company> companyRepo) {
	...
	private void seeding() {
		...
		companyList.add(new Company("CT987654321", "company_logo_2.png",
				...
				List.of(PaymentOption.BANK_TRANSFER, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		companyList.add(new Company("CA345678901", "logo3.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.STRIPE), LocalDate.now(), null, null, null));
		companyList.add(new Company("UK234567890", "logo4.png",
				...
				List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		companyList.add(new Company("DE456789012", "logo5.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		companyList.add(new Company("FR567890129", "logo6.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		companyList.add(
				new Company("AS678901234", "logo7.png", new Address("Australia", "Sydney", "2000", "George St", "456"),
						...
						7539518462L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), LocalDate.now(), null, null, null));
		companyList.add(new Company("JP789012345", "logo8.png",
				new Address("Japan", "Tokyo", "100-0004", "Shibakoen", "789"),
				new Contact("789012345", "email8@example.com"), "Tech Innovations KK", "Technology", 1592637480L,
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("SA901234567", "logo10.png",
				...
				9876543210L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		// 10
		companyList.add(new Company("ES109876543", "logo11.png",
				new Address("Spain", "Madrid", "28001", "Gran Vía", "789"),
				new Contact("109876543", "email11@example.com"), "Healthcare Solutions S.L.", "Healthcare", 1234567890L,
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.STRIPE), LocalDate.now(), null, null, null));
		companyList.add(
		...
		companyList.add(new Company("IN321098765", "logo13.png",
				...
				3456789012L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		companyList.add(
				new Company("CH43210987", "logo14.png", new Address("China", "Shanghai", "200002", "Nanjing Rd", "789"),
						...
						4567890123L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("MX654321098", "logo16.png",
				...
				6789012345L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		companyList.add(new Company("CA765432109", "logo17.png",
				...
				7890123456L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("SP234567890", "logo24.png",
				...
				List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), LocalDate.now(), null, null, null));
		companyList.add(new Company("SK245678901", "logo25.png",
				...
				6543210987L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null,
				null, null));
		companyList.add(new Company("AR256789012", "logo26.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		companyList.add(new Company("DK267890123", "logo27.png",
				new Address("Denmark", "Copenhagen", "1123", "Nyhavn", "123"),
				new Contact("267890123", "email27@example.com"), "Engineering Innovations ApS", "Engineering",
				8765432109L, List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("CH356789012", "logo36.png",
				...
				2678901234L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("IT390123456", "logo40.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		companyList.add(new Company("SP401234567", "logo41.png",
				new Address("Spain", "Barcelona", "08002", "La Rambla", "789"),
				new Contact("401234567", "email41@example.com"), "Tech Innovations S.L.", "Technology", 4012345678L,
				List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		// 40
		companyList.add(new Company("CA412345678", "logo42.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.STRIPE), LocalDate.now(), null, null, null));
		companyList.add(new Company("DE423456789", "logo43.png",
				new Address("Germany", "Frankfurt", "60313", "Zeil", "456"),
				new Contact("423456789", "email43@example.com"), "Fashion Innovations GmbH", "Retail", 4234567890L,
				List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("UK445678901", "logo45.png",
				...
				4456789012L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("JP467890123", "logo47.png",
				...
				List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("US523456789", "logo53.png",
				...
				5234567890L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("FR545678901", "logo55.png",
				...
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		companyList.add(new Company("IT556789012", "logo56.png",
				new Address("Italy", "Naples", "80132", "Via Toledo", "789"),
				new Contact("556789012", "email56@example.com"), "Retail Innovations Italia", "Retail", 5567890123L,
				List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		...
		companyList.add(
				new Company("CA90123456L", "logo60.png", new Address("Canada", "Toronto", "M5B 1R7", "Yonge St", "123"),
						...
						5901234567L, List.of(PaymentOption.PAYPAL, PaymentOption.STRIPE), LocalDate.now(), null, null, null));
		companyList.add(new Company("DE601234567", "logo61.png",
				...
				6012345678L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null,
				null, null));
		// 60
		...
		companyList.add(new Company("BE801234567", "logo81.png",
				...
				8012345678L, List.of(PaymentOption.CREDIT_CARD, PaymentOption.BANK_TRANSFER), LocalDate.now(), null,
				null, null));
		...
		companyList
				.add(new Company("BE823456789", "logo83.png", new Address("Belgium", "Ghent", "9000", "Graslei", "789"),
						...
						List.of(PaymentOption.CREDIT_CARD, PaymentOption.STRIPE), LocalDate.now(), null, null, null));
		// 70
		companyList.add(new Company("BE834567890", "logo84.png",
				new Address("Belgium", "Bruges", "8000", "Burg Square", "123"),
				new Contact("834567890", "email84@example.com"), "Retail Innovations BVBA", "Retail", 8345678901L,
				List.of(PaymentOption.PAYPAL, PaymentOption.BANK_TRANSFER), LocalDate.now(), null, null, null));
		companyList.add(new Company("BE845678901", "logo85.png",
				new Address("Belgium", "Leuven", "3000", "Oude Markt", "456"),
				new Contact("845678901", "email85@example.com"), "Tech Innovations NV", "Technology", 8456789012L,
				List.of(PaymentOption.CREDIT_CARD, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
		...
		companyList.add(new Company("BE878901234", "logo88.png",
				...
				8789012345L, List.of(PaymentOption.PAYPAL, PaymentOption.BITCOIN), LocalDate.now(), null, null, null));
