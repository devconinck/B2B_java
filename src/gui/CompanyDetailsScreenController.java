    ...
    public void persistCompany() {
        if (isInputValid()) {
            ...
            if (existingCompany != null) {
                ...
                Company tempCompany = new Company(vatField.getText(), logoUrlField.getText(), tempAddress, tempContact, nameField.getText(), sectorField.getText(), Long.parseLong(bankField.getText()), selectedOptions, customerStartDate);
